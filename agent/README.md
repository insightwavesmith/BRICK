...
돌려주는지). 축 전체 개념 지도는 `support/docs/references/architecture-map.md`.

## 오해 방지

- `agent/skills/`와 `brick/templates/skills/`의 중복은 실수가 아니라 **의도된 3면 동기화**.
  동기 규칙은 `brick/templates/skills/APPLY-LIST.md` 참조.
