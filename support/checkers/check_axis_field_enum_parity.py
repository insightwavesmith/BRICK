...
ENUM_PAIRS = [
    ("brick/comparison.yaml", "allowed_observed_match_kind", "",
     "brick/comparison.py", "_OBSERVED_MATCH_KINDS"),
    # NOTE: link/movement.yaml movement_literals is intentionally NOT listed here.
    ...
    ("link/gate.yaml", "stage_literals", "",
     "link/gate.py", "GATE_STAGE_LITERALS"),
    ("link/gate.yaml", "sufficiency_literals", "",
     "link/gate.py", "GATE_SUFFICIENCY_LITERALS"),
    ("link/carry.yaml", "source_owner_axis_literals", "",
     "link/carry.py", "SOURCE_OWNER_AXIS_LITERALS"),
]
...
BOUNDARY_CONSTRAINT_MODULES = (
    ("link/transfer.yaml", "link/transfer.py"),
    ("link/carry.yaml", "link/carry.py"),
)
