...
PARENTS_BINDING_REGISTRY = {
    ...
    "support/checkers/check_agent_resource_resolution.py": {2},
    "support/checkers/check_assembly_equivalence.py": {2},
    "support/checkers/check_axis_crossing_elegance.py": {2},
    ...
    "support/checkers/check_builder_consumes_axis_api.py": {2},
    "support/checkers/check_building_lifecycle_path_shape.py": {2},
    "support/checkers/check_building_operator_driver0.py": {2},
    "support/checkers/check_chained_carry_dependency.py": {2},
    "support/checkers/check_charter_injection.py": {2},
    ...
    "support/checkers/check_evidence_spine.py": {2},
    "support/checkers/check_evidence_spine_projection.py": {2},
    ...
    "support/checkers/check_package_path_admission.py": {2},
    "support/checkers/check_pin_estate_integrity.py": {2},
    "support/checkers/check_plan_revision_chain.py": {2},
    ...
    "support/checkers/check_resume_disposition_surface.py": {2},
    "support/checkers/check_resume_replay_disposition_mirror.py": {2},
    ...
    "support/checkers/check_tier_a_three_axis_conformance.py": {2},
