...
from support.checkers.lib.plan_fixture_helpers import _graph_test_plan_from_linear
...
def run_casting_node_carry(repo: Path) -> KernelResult:
    ...
    drives the genuine ``support/operator/plan_graph._linear_plan_from_graph_plan``
    ...
    from support.operator.primitives import NODE_CASTING_FIELDS
