...
def run_sakana_wire_packet(repo: Path) -> KernelResult:
    ...
    mutation_packet["prompt_resources"][0]["path"] = "agent/prompts/dev.md"
    mutation_packet["tool_policy_resources"][0]["path"] = "agent/tool_policies/read-write-scoped.yaml"
    mutation_packet["hook_resources"]["registry_path"] = "agent/hooks/registry.yaml"
    try:
