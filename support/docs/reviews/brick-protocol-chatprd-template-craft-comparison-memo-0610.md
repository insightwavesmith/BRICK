...
| --- | --- |
| Physical surface | `support/docs/reviews/brick-protocol-chatprd-template-craft-comparison-memo-0610.md` |
...
| Derives from | Brick `agent/prompts/{dev,pm-lead,cto-lead,design-lead}.md`, `agent/skills/{software-architecture,scoped-implementation,code-analyzer,gap-detector,design-depth-check}/SKILL.md`, and an external read of the ChatPRD in-app template bodies. |
...
- `agent/prompts/dev.md`, `agent/prompts/pm-lead.md`, `agent/prompts/cto-lead.md`, `agent/prompts/design-lead.md`
- `agent/skills/software-architecture/SKILL.md`, `agent/skills/scoped-implementation/SKILL.md`, `agent/skills/code-analyzer/SKILL.md`, `agent/skills/gap-detector/SKILL.md`, `agent/skills/design-depth-check/SKILL.md`
