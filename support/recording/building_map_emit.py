...
``support/recording/operator_evidence.py`` iterating the per-axis field-spec in
``support/recording/contracts.py``; this emitter supplies the per-step payload
...
def _accumulated_building_map_packet(
    ...
    *,
    ...
    for index, result in enumerate(step_results, start=1):
        ...
        # is built by support/recording/operator_evidence.py iterating the per-axis
...
def _adapter_error_frontier_building_map_packet(
    ...
    *,
    ...
    packet = {
        ...
        # by support/recording/operator_evidence.py from the frontier-observation
        # field-spec in support/recording/contracts.py).
