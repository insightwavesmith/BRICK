...
def _path_matches_scope(path: str, pattern: str) -> bool:
    ...
    Moved verbatim from ``brick_protocol/support/operator/write_observation`` as part of the
...
def compare_changed_paths_to_write_scope(
    ...
    ``brick_protocol/support/operator/write_observation`` into the Brick axis. The support write
