...
> 3면 동기화 계약: **agent/skills/ = 운영 정본**(체커 pin 대상), `brick_protocol/brick/templates/skills/` =
...
적용 후 `PYTHONPATH=brick_protocol/support/import_identity uv run python3 brick_protocol/support/checkers/check_profile.py
