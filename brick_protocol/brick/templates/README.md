# brick_protocol/brick/templates — Brick 축의 물리 양식 선반 (a stranger's map)
...
- `shapes/` — the catalog/menu (`catalog.yaml`, `shapes.yaml`): checker
  infrastructure and shape menu, not work sheets.
- `building-design-contract.yaml` — the human↔COO building-design TABLE contract.
