...
required_return_template_refs:
  - brick_protocol/brick/templates/bricks/evidence-integrity/return.yaml
...
> instruction (brick_protocol/support/connection/adapter_grant_policy._build_prompt, key `brick_instruction_body`),
