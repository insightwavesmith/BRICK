...
required_return_template_refs:
  - brick_protocol/brick/templates/bricks/axis-attack-qa/return.yaml
...
(shape: `brick_protocol/brick/templates/bricks/transition-concern-return.yaml`) is **local, non-binding** Agent
