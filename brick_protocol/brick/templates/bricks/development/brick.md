...
required_return_template_refs:
  - brick_protocol/brick/templates/bricks/development/return.yaml
...
> This `## development` body IS delivered to the Agent in the prompt as the static kind instruction
