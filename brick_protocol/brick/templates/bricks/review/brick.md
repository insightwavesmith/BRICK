...
required_return_template_refs:
  - brick_protocol/brick/templates/bricks/review/return.yaml
...
`transition_concern_evidence` (shape: `brick_protocol/brick/templates/bricks/transition-concern-return.yaml`) is
