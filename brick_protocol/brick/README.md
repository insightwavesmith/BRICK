# brick_protocol/brick/ — Brick 축 (WHAT / 일 그 자체)
...
- `templates/skills/`와 `brick_protocol/agent/skills/`의 중복은 실수가 아니라 **의도된 3면 동기화**
  (레포 원본 ↔ 운영자 설치본 등). 동기 규칙은 `brick_protocol/brick/templates/skills/APPLY-LIST.md` 참조.
