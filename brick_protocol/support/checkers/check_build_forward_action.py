...
Drives ``resolve_build_action`` (brick_protocol/support/operator/assembly.py) over a fixed
...
Probes (default --variant none):
  ...
  P6  CLI wiring literals present in brick_protocol/support/operator/cli.py
