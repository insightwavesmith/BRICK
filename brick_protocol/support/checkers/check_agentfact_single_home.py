...
The Agent contract projections (brick_protocol/agent/receipt.yaml, brick_protocol/agent/return_fact.yaml)
...
``AgentFact`` class must be defined in exactly one python module, brick_protocol/agent/
...
SOURCE_DIRS = ("brick_protocol/brick", "brick_protocol/agent", "brick_protocol/link", "brick_protocol/support")
CANONICAL_HOME = "brick_protocol/agent/return_fact.py"
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "(brick_protocol/agent/return_fact.py). Does not prove correctness, source truth, "
