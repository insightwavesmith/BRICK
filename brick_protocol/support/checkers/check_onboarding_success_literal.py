...
def check_repo(repo: Path) -> None:
    ...
    install_text = texts["brick_protocol/support/onboarding/install.sh"]
    install_needles = (
        '"$brick_entry" verify',
        FAILURE_LITERAL,
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        "brick_protocol/support/docs/references/quickstart.md, and brick_protocol/support/onboarding/install.sh "
