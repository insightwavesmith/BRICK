...
admitted dynamic graph walker (brick_protocol/support/operator/dynamic_walker.py) over adapter:
...
def _brick_step(step_ref: str, brick_ref: str, agent_ref: str, completion_edge_ref: str) -> Mapping[str, Any]:
    return fixture_graph_brick_step(
        ...
        source_facts=["AGENTS.md", "brick_protocol/support/operator/dynamic_walker.py"],
    )
...
def _multi_ref_concern_callable(
    ...
    *,
    ...
    defaults to () in brick_protocol/agent/return_fact.validate_transition_concern_evidence).
    """
...
def _append_disposition_row(
    ...
    *,
    ...
    if reason_refs is not None:
        ...
        # (brick_protocol/link/transition.TRANSITION_LIFECYCLE_ALLOWED_KEYS); the disposition
...
def check(repo: Path) -> list[str]:
    ...
    from brick_protocol.support.checkers import check_building_lifecycle_path_shape
    ...
    resolved_policy = _materializer_closure_policy(
        {
            "implementation_gap": {
                "action": "reroute",
                "target_step_template_ref": "brick_protocol/brick/templates/bricks/work/brick.md",
            }
        },
    ...
    if resolved_policy != {
        "implementation_gap": {
            "action": "reroute",
            "target_ref": "route-policy-field-real-brick-protocol-brick-templates-bricks-work-brick-md",
        }
    }:
        violations.append(
    ...
    # is an admitted non-brick-node prefix (brick_protocol/agent/return_fact.py). The walk must
    ...
    invalid_address_refs = {
        ...
        "bare file:line citation": "brick_protocol/agent/return_fact.py:128",
    ...
    invalid_boundary_refs = {
        ...
        "bare file:line citation": "brick_protocol/agent/return_fact.py:128",
        "slash path": "brick_protocol/brick/templates/bricks/work/return.yaml",
    ...
    with checker_temp_path("bp-bapr-mail-8-") as tmp:
        ...
        illegal_refs_m8 = {
            ...
            "bare file:line citation": "brick_protocol/brick/work.py:1",
            "non-step-output slash path": "raw/link.jsonl",
        }
    ...
    walker_src = (repo / "brick_protocol" / "support" / "operator" / "dynamic_walker.py").read_text(encoding="utf-8")
