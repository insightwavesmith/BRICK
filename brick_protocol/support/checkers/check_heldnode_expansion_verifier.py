...
def _write_base_packet(root: Path, plan: Mapping[str, Any]) -> None:
    from brick_protocol.support.recording.declaration_packets import (  # noqa: PLC0415
...
def _expand_candidate(repo: Path, parent_plan: Mapping[str, Any]) -> Mapping[str, Any]:
    from brick_protocol.support.operator.assembly import Authority, Gate, expand  # noqa: PLC0415

    work_statement = (
        "## Deliverables\n"
        "D1: edit brick_protocol/support/checkers/check_heldnode_expansion_verifier.py fixture evidence.\n"
...
def _assert_rejects_without_disposition(
    ...
    from brick_protocol.support.recording.declaration_packets import write_declared_plan_revision  # noqa: PLC0415
...
def _verify_green(repo: Path, mutate: str | None = None) -> list[str]:
    from brick_protocol.agent.return_fact import validate_transition_concern_evidence  # noqa: PLC0415
    from brick_protocol.support.recording.declaration_packets import latest_valid_declared_plan  # noqa: PLC0415
