...
from brick_protocol.support.checkers.lib.checker_temp_vessel import _case_slug, _preset_slug
from brick_protocol.support.checkers.lib.gate_evidence_readers import _assert_no_missing_gate_facts
from brick_protocol.support.checkers.lib.plan_fixture_helpers import _optional_positive_int
...
def run_preset_building_completion_case(repo: Path, profile: Mapping[str, Any]) -> int:
    ...
    from brick_protocol.support.operator.building_operation import materialize_building_intent, observe_building_frontier
...
def _run_preset_completion_portfolio(
    *,
    ...
    from brick_protocol.support.operator.composition_gate_translation import declared_portfolio_gate_translations
...
from brick_protocol.support.checkers.lib.case_runners import _canonical_chain_preset_refs
