...
from brick_protocol.support.checkers.lib.yaml_subset import KernelResult, ProfileError  # noqa: E402

CHECK_ID = "re_instruction_endline_gate"
_LEDGER_CONSUMER_TEXT = (
    "Consumed by brick_protocol/support/operator/onboard.py run_approve_entry adoption-time "
    "check + brick_protocol/support/checkers/lib/re_instruction_endline_gate_check.py kernel "
