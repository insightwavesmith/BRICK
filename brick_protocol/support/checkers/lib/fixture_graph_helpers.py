...
def fixture_graph_link_edge(
    ...
    *,
    ...
    brick_protocol/support/checkers/check_bounded_agent_proposed_routing_loop0.py:87 and :822,
    while case_runners treats only ``None`` as default at
    brick_protocol/support/checkers/lib/case_runners.py:7995. Set
...
def fixture_graph_helpers_self_check_violations() -> list[str]:
    ...
    from brick_protocol.support.checkers import check_bounded_agent_proposed_routing_loop0 as loop0
    from brick_protocol.support.checkers.lib import case_runners
