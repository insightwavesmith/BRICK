...
def run_workflow_import_case(repo: Path, profile: Mapping[str, Any]) -> int:
    ...
    the real brick_protocol/support/operator/workflow_import.py verbs and asserts:
    ...
    from brick_protocol.support.operator.composition_intent import LINEAR_COMPOSITION_MODE
    from brick_protocol.support.checkers.check_building_declaration_integrity import (
