...
from brick_protocol.support.checkers.lib.chat_session_park_check import _chat_session_park_graph_plan
...
def run_adapter_error_frontier_manifest_consistency(repo: Path) -> KernelResult:
    ...
    from brick_protocol.support.recording.raw_claim_trace import reconcile_claim_trace_raw_manifest_from_raw
    from brick_protocol.support.recording.lifecycle_emit import _accumulated_raw_manifest
...
def _adapter_error_manifest_entry(path: str, axis_owner: str, raw_refs: Sequence[str]) -> dict[str, Any]:
    return {
        "path": path,
        "source": "brick_protocol/support/checkers synthetic fixture",
