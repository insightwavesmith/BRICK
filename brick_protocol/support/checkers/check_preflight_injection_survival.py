...
WRITE_SCOPE = {
    "allowed_paths": ["brick_protocol/support/operator/task_order_preflight.py"],
    "forbidden_paths": [".git/**"],
}
...
def _assert_wiring_present(repo: Path) -> None:
    assembly_text = (repo / "brick_protocol/support/operator/assembly.py").read_text(encoding="utf-8")
    preflight_text = (repo / "brick_protocol/support/operator/task_order_preflight.py").read_text(encoding="utf-8")
