...
# directly under brick_protocol/support/checkers (not under profiles/). Support record only.
CROSSING_ELEGANCE_REGISTRY_FILES = {
    "brick_protocol/support/checkers/crossing_registry.yaml",
    ...
    # append-only support record directly under brick_protocol/support/checkers.
    "brick_protocol/support/checkers/pin_estate_baseline.yaml",
    ...
    "brick_protocol/support/checkers/field_set_registry.yaml",
    ...
    # registries: append-only support record directly under brick_protocol/support/checkers.
    "brick_protocol/support/checkers/judgment_home.yaml",
...
AXIS_README_TARGETS = {
    ...
    "brick_protocol/agent/README.md",
    "brick_protocol/link/README.md",
    "brick_protocol/support/README.md",
}

PACKAGE_MARKERS = {
    "brick_protocol/__init__.py",
    "brick_protocol/brick/__init__.py",
    "brick_protocol/agent/__init__.py",
    "brick_protocol/link/__init__.py",
    "brick_protocol/support/__init__.py",
    "brick_protocol/support/checkers/__init__.py",
    "brick_protocol/support/checkers/lib/__init__.py",
    "brick_protocol/support/connection/__init__.py",
    "brick_protocol/support/operator/__init__.py",
    "brick_protocol/support/recording/__init__.py",
}

C2_IMPORT_UNIFY_TARGETS = {
    "brick_protocol/agent/hooks/bindings.yaml",
    "brick_protocol/agent/hooks/registry.yaml",
    "brick_protocol/support/checkers/lib/hook_registry_axis_check.py",
    "brick_protocol/support/checkers/lib/onboard_smoke_check.py",
}

PHASE4_CORE_TARGETS = {
    "brick_protocol/brick/work.py",
    "brick_protocol/brick/work.yaml",
    "brick_protocol/agent/return_fact.py",
    "brick_protocol/agent/return_fact.yaml",
    "brick_protocol/link/movement.py",
    "brick_protocol/link/movement.yaml",
}

PHASE4_EXPANSION_TARGETS = {
    "brick_protocol/agent/receipt.py",
    "brick_protocol/agent/receipt.yaml",
    "brick_protocol/agent/performance.py",
    "brick_protocol/agent/performance.yaml",
    "brick_protocol/brick/building.py",
    "brick_protocol/brick/building.yaml",
    "brick_protocol/brick/comparison.py",
    "brick_protocol/brick/comparison.yaml",
    "brick_protocol/link/gate.py",
    "brick_protocol/link/gate.yaml",
    "brick_protocol/link/transition.py",
    "brick_protocol/link/transition.yaml",
}
...
LTC0_LINK_TRANSFER_CARRY_TARGETS = {
    ...
    "brick_protocol/link/transfer.yaml",
    "brick_protocol/link/carry.py",
    "brick_protocol/link/carry.yaml",
}

# E2 / S3 (mirror M11): brick_protocol/link/spec.py — the START of the Link single-source plan-
# grammar API. Owns the gate-concept translation table + translate_gate_concept
# (moved from brick_protocol/support/operator/composition.py); later E2 steps fold the Link
...
# E2 / S6 (mirror M5+M6+M9): brick_protocol/agent/spec.py — the Agent single-source CASTING API.
# Owns the CastingField descriptor + CASTING_FIELDS field-set (moved from
# brick_protocol/support/operator/primitives.py), its selected_* projection, and the casting
# transport helpers. A code-only axis module (no paired projection YAML yet);
# admitted as an Agent axis surface, the Agent-axis sibling of brick_protocol/link/spec.py.
AGENT_SPEC0_TARGETS = {
    "brick_protocol/agent/spec.py",
}

# E2 / S9 (mirror M + J5 + axis-leak fix): brick_protocol/brick/spec.py — the Brick single-source
# DECLARABLE-contract API. Owns BRICK_ROW_ALLOWED_KEYS (moved from
# brick_protocol/support/operator/primitives.py), the WriteScope value object (shape +
# clean/validate, MOVED from brick_protocol/support/connection/agent_adapter.py — a Brick-axis
# value object that had been in a support file named for the AGENT axis), the
# default worktree write envelope (moved from brick_protocol/support/operator/assembly.py), and
# the write-NEED value interpreter (J5, moved from
# brick_protocol/support/operator/plan_validation.py). A code-only axis module (no paired
# projection YAML yet); admitted as a Brick axis surface, the Brick-axis sibling
# of brick_protocol/link/spec.py + brick_protocol/agent/spec.py.
BRICK_SPEC0_TARGETS = {
    "brick_protocol/brick/spec.py",
}
...
AGENT_ADAPTER0_TARGETS = {
    ...
    # ownership moved.
    "brick_protocol/support/connection/adapter_constants.py",
    "brick_protocol/support/connection/adapter_validation.py",
    ...
    "brick_protocol/support/connection/adapter_gemini_http.py",
...
COO_SYNC0_TARGETS = {
    "brick_protocol/support/connection/coo_sync.py",
}

MCP_PROJECTION0_TARGETS = {
    "brick_protocol/support/connection/mcp_projection.py",
}
...
SECRET_TEXT0_TARGETS = {
    "brick_protocol/support/connection/secret_text.py",
}
...
ONBOARD_WIZARD0_TARGETS = {
    ...
    "brick_protocol/support/operator/re_instruction_rules.py",
}
...
PROJECT_DECLARATION0_TARGETS = {
    "brick_protocol/support/operator/project_declaration.py",
}
...
WORKFLOW_IMPORT0_TARGETS = {
    "brick_protocol/support/operator/workflow_import.py",
}
...
ONBOARD_RELEASE_EXPORT0_TARGETS = {
    "brick_protocol/support/onboarding/release_product_manifest.json",
    "brick_protocol/support/onboarding/release_export.sh",
    "brick_protocol/brick/templates/graph-decls/postmortem-deep.json",
    "brick_protocol/support/onboarding/coo_gate_runner.sh",
    "brick_protocol/support/onboarding/release_gate.sh",
}
...
# opt-in recording step (brick_protocol/support/operator/onboard.py) copies into a checkout's
...
ONBOARD_RECORDING_HOOK_TEMPLATE_TARGETS = {
    "brick_protocol/support/onboarding/claude-hooks/open-recording.py",
    "brick_protocol/support/onboarding/claude-hooks/close-recording.py",
    "brick_protocol/support/onboarding/codex-hooks/codex-open-recording.py",
    "brick_protocol/support/onboarding/codex-hooks/codex-close-recording.py",
}
...
BAR_V2_OPERATOR_TARGETS = {
    ...
    "brick_protocol/support/operator/contracts.py",
    # BOUNDED-AGENT-PROPOSED-ROUTING-LOOP-0 admits the dynamic graph walker as a
    # new brick_protocol/support/operator module (the only new module the amendment admits).
    "brick_protocol/support/operator/dynamic_walker.py",
    "brick_protocol/support/operator/evidence_assembly.py",
    "brick_protocol/support/operator/plan_graph.py",
    "brick_protocol/support/operator/plan_validation.py",
    "brick_protocol/support/operator/portfolio_projection.py",
...
REPORTER_NOTIFICATION_PROJECTION0_TARGETS = {
    "brick_protocol/support/operator/label_map.json",
...
REPORT_ENV_AUTOLOAD0_TARGETS = {
    "brick_protocol/support/operator/runtime_env.py",
}
...
# SSE server) is the vendored brick_protocol/support/dashboard surface admitted ONLY via
...
DASHBOARD_EXPORT0_TARGETS = {
    "brick_protocol/support/operator/dashboard_export.py",
}
DASHBOARD_SURFACE_ROOT = "brick_protocol/support/dashboard"
...
# brick_protocol/support/operator/dynamic_walker.py. Each is a registered module_registry.yaml
...
ELEGANT_REFACTOR_WALKER_TARGETS = {
    ...
    "brick_protocol/support/operator/walker_runtime_mail.py",
    "brick_protocol/support/operator/walker_resume_seed.py",
    "brick_protocol/support/operator/walker_report_events.py",
...
# brick_protocol/support/operator/building_operation.py. Each is a registered
...
ELEGANT_REFACTOR_BUILDING_OPERATION_TARGETS = {
    "brick_protocol/support/operator/building_operation_common.py",
    "brick_protocol/support/operator/checker_runner.py",
    "brick_protocol/support/operator/evidence_status.py",
    "brick_protocol/support/operator/ledger_projection.py",
    "brick_protocol/support/operator/frontier_observation.py",
    ...
    *SINK_REGISTRY0_TARGETS,
    ...
    # no fourth axis.
    "brick_protocol/support/operator/composition_problem.py",
    "brick_protocol/support/operator/composition_common.py",
    "brick_protocol/support/operator/composition_kinds.py",
    ...
    "brick_protocol/support/operator/composition_graph_emit.py",
    "brick_protocol/support/operator/composition_graph_validate.py",
    "brick_protocol/support/operator/composition_compose.py",
    ...
    "brick_protocol/support/operator/worktree_sandbox.py",
}

# HEART front door: assembly.py -- the refined 3-axis builder API
# (brick_protocol/brick/agent/chain/fan_out/fan_in/edge/converge/reroute/hold/assemble). The
...
# list so it is not an orphan. A new kind is DATA (no brick_protocol/brick/spec edit). Owns no
# crossing, casts no agent, judges nothing.
BRICK_KIND_SCAFFOLD0_TARGETS = {
    "brick_protocol/support/operator/brick_kind_scaffold.py",
}

TASK_ORDER_PREFLIGHT0_TARGETS = {
    "brick_protocol/support/operator/task_order_preflight.py",
}
...
DRAFT_DIFF0_TARGETS = {
    "brick_protocol/support/operator/draft_diff.py",
}
...
PLAN_EXPANSION0_FIXTURES = {
    "brick_protocol/support/checkers/fixtures/plan_expansion/valid_merge.json",
    "brick_protocol/support/checkers/fixtures/plan_expansion/cycle.json",
    "brick_protocol/support/checkers/fixtures/plan_expansion/missing_fan_in_member.json",
    "brick_protocol/support/checkers/fixtures/plan_expansion/upstream_target.json",
...
PRH_B_RECORDER_TARGETS = {
    ...
    "brick_protocol/support/recording/building_map.py",
    ...
    "brick_protocol/support/recording/spine.py",
    ...
    # evidence, no BAL fact class, no fourth axis.
    "brick_protocol/support/recording/operator_evidence.py",
    ...
    "brick_protocol/support/recording/operator_correction.py",
    ...
    # brick_protocol/support/operator/evidence_assembly.py. Each is a registered
    ...
    "brick_protocol/support/recording/claims_common.py",
    "brick_protocol/support/recording/claims_brick.py",
    "brick_protocol/support/recording/claims_agent.py",
    "brick_protocol/support/recording/claims_link.py",
    "brick_protocol/support/recording/claims_carry_budget.py",
    "brick_protocol/support/recording/claims_assembly.py",
    "brick_protocol/support/recording/declaration_packets.py",
    "brick_protocol/support/recording/building_map_emit.py",
    "brick_protocol/support/recording/lifecycle_emit.py",
    ...
    # no building-stop.
    "brick_protocol/support/recording/agent_step_observation.py",
}
...
MINIMAL_BUILDING_LIFECYCLE_RECORDS = {
    # run_building_intake (brick_protocol/support/operator/driver.py) writes its materialized
...
# brick_protocol/support/docs/templates admission class is retired with it (no live template
# files remain under brick_protocol/support/docs/templates).
SUPPORT_DOC_TEMPLATE_FILES: set[str] = set()

TEMPLATE0_BRICK_TEMPLATE_DIRS = {
    "brick_protocol/brick/templates",
    "brick_protocol/brick/templates/graph-decls",
    "brick_protocol/brick/templates/closure",
    "brick_protocol/brick/templates/design",
    "brick_protocol/brick/templates/bricks",
    "brick_protocol/brick/templates/do",
    "brick_protocol/brick/templates/presets",
    "brick_protocol/brick/templates/review",
    "brick_protocol/brick/templates/shapes",
    "brick_protocol/brick/templates/skills",
    "brick_protocol/brick/templates/tasks",
}
...
BRICK_BUILDING_PLAN_DIRS = {
    "brick_protocol/brick/building_plans",
}

BAR_V2_LINK_DATA_DIRS = {
    "brick_protocol/link/route_policies",
}

AGENT_RESOURCE0_DIRS = {
    "brick_protocol/agent/objects",
    "brick_protocol/agent/prompts",
    "brick_protocol/agent/skills",
    "brick_protocol/agent/hooks",
    "brick_protocol/agent/tool_policies",
    "brick_protocol/agent/disciplines",
}
...
ALLOWED_DIRS = {
    ...
    "brick_protocol/support/onboarding/assets",
    "brick_protocol/support/onboarding/claude-hooks",
    "brick_protocol/support/onboarding/codex-hooks",
    "brick_protocol/support/import_identity",
    "project",
    ...
    *BAR_V2_LINK_DATA_DIRS,
    ...
    "brick_protocol/support/checkers",
    "brick_protocol/support/checkers/lib",
...
def c2_axis_relative(path: str) -> str:
    """Return the pre-C2 axis-relative spelling for migrated families."""
    ...
    for prefix in (
        ...
        if path.startswith(prefix):
            return path.removeprefix("brick_protocol/")
    if path in {
        "brick_protocol/agent",
        "brick_protocol/brick",
        "brick_protocol/link",
...
# slug law in brick_protocol/support/recording/capture.is_project_id_slug (this foundational
...
def is_template0_brick_template_path(path: str, is_dir: bool) -> bool:
    ...
    return (
        ...
        and parts[2] in {item.rsplit("/", 1)[-1] for item in TEMPLATE0_BRICK_TEMPLATE_DIRS if item != "brick_protocol/brick/templates"}
...
def is_c2_link_route_policy_path(path: str, *, is_dir: bool) -> bool:
    parts = path.split("/")
    if parts[:3] != ["brick_protocol", "link", "route_policies"]:
        return False
    if len(parts) == 3:
        return is_dir
    return (
...
def is_dashboard_surface_path(path: str, *, is_dir: bool) -> bool:
    ...
    A self-contained React + SSE-server surface under brick_protocol/support/dashboard. Its JS
...
def _spine_event_types() -> frozenset[str]:
    ...
    only ever classify brick_protocol/support/*.py paths through it). Bootstraps the
...
def is_project_building_lifecycle_path(path: str, *, is_dir: bool) -> bool:
    ...
    if len(parts) == 4 and not is_dir:
        ...
        # brick_protocol/support/operator/onboard.py persists a pre-run frozen composed-plan
...
def ignored_repo_path(path: str) -> bool:
    ...
    if path == ".codex" or path.startswith(".codex/"):
        return True
    # W1 worktree sandbox marker: brick_protocol/support/operator/worktree_sandbox.py stamps
    ...
    # documented installer (brick_protocol/support/onboarding/install.sh -> uv sync). The
    ...
    if "node_modules" in path.split("/"):
        return True
    if path == "brick_protocol/support/dashboard/dist" or path.startswith("brick_protocol/support/dashboard/dist/"):
        return True
    if path == "brick_protocol/support/dashboard/public/dashboard-data.json":
        return True
...
def forbidden_reason(path: str) -> str | None:
    ...
    if clean in C2_IMPORT_UNIFY_TARGETS:
        return None
    old_physical_roots = {
        "brick_protocol/runner": "brick_protocol/support/operator/run.py",
        "brick_recorder": "brick_protocol/support/recording/",
    ...
    if (
        clean in {
            ...
            "gate.yaml",
            "gate.yml",
            "brick_protocol/brick/gate.py",
            "brick_protocol/brick/gate.yaml",
            "brick_protocol/brick/gate.yml",
            "brick_protocol/agent/gate.py",
            "brick_protocol/agent/gate.yaml",
            "brick_protocol/agent/gate.yml",
        ...
        or clean == "brick_protocol/brick/gate"
        or clean.startswith("brick_protocol/brick/gate/")
        or clean == "brick_protocol/agent/gate"
        or clean.startswith("brick_protocol/agent/gate/")
        or clean == "brick_protocol/gate"
        or clean.startswith("brick_protocol/gate/")
        or clean == "brick_protocol/link/gate"
        or clean.startswith("brick_protocol/link/gate/")
    ):
    ...
    if (
        clean in {
            ...
            "carry.yaml",
            "carry.yml",
            "brick_protocol/brick/transfer.py",
            "brick_protocol/brick/transfer.yaml",
            "brick_protocol/brick/transfer.yml",
            "brick_protocol/agent/transfer.py",
            "brick_protocol/agent/transfer.yaml",
            "brick_protocol/agent/transfer.yml",
            "brick_protocol/transfer.py",
            "brick_protocol/transfer.yaml",
            "brick_protocol/transfer.yml",
            "brick_protocol/brick/carry.py",
            "brick_protocol/brick/carry.yaml",
            "brick_protocol/brick/carry.yml",
            "brick_protocol/agent/carry.py",
            "brick_protocol/agent/carry.yaml",
            "brick_protocol/agent/carry.yml",
            "brick_protocol/carry.py",
            "brick_protocol/carry.yaml",
            "brick_protocol/carry.yml",
        }
        or clean in {"transfer", "carry", "brick_protocol/brick/transfer", "brick_protocol/agent/transfer", "brick_protocol/brick/carry", "brick_protocol/agent/carry"}
        or clean.startswith("transfer/")
        or clean.startswith("carry/")
        or clean.startswith("brick_protocol/brick/transfer/")
        or clean.startswith("brick_protocol/agent/transfer/")
        or clean.startswith("brick_protocol/brick/carry/")
        or clean.startswith("brick_protocol/agent/carry/")
    ...
    if clean == "brick_protocol/support/recording/__main__.py":
        return (
            "brick_protocol/support/recording/__main__.py is a superseded public recorder "
            "entrypoint; SIMPLE-RUN-0 keeps brick_protocol/support/operator/run.py as the public "
            "Building run entrypoint"
        )

    if clean == "brick_protocol/support/run.py":
        return (
            "brick_protocol/support/run.py is superseded by brick_protocol/support/operator/run.py as the "
            "active public Building run surface"
        )

    if clean in {
        "brick_protocol/support/agent_adapter.py",
        "brick_protocol/support/agent_resources.py",
        "brick_protocol/support/coo_sync.py",
        "brick_protocol/support/mcp_projection.py",
    }:
        return (
            f"{clean} is superseded by brick_protocol/support/connection/ as the active "
            "support connection folder"
        )

    if clean.startswith("brick_protocol/support/recording/") and clean.endswith(".py"):
        if clean not in PRH_B_RECORDER_TARGETS:
            return (
                f"unadmitted support recording path {clean}; PRH-B admits only "
                "the packet writer namespace under brick_protocol/support/recording"
            )
    ...
    if clean == "brick_protocol/support/status" or clean.startswith("brick_protocol/support/status/"):
        return (
            f"old support status path {clean} is superseded by "
            "project/brick-protocol/status/ as the active status root"
        )

    if clean.startswith(("brick_protocol/brick/", "brick_protocol/agent/", "brick_protocol/link/")) and clean.endswith((".py", ".yaml", ".yml")):
        ...
        if is_bar_v2_link_data_path(clean, is_dir=is_dir):
            return None
        if is_c2_link_route_policy_path(clean, is_dir=is_dir):
            return None
        if (
            clean not in (PACKAGE_MARKERS | C2_IMPORT_UNIFY_TARGETS)
            ...
            return (
                ...
                "file pairs and the E2/S3 brick_protocol/link/spec.py + E2/S6 brick_protocol/agent/spec.py "
                "+ E2/S9 brick_protocol/brick/spec.py axis surfaces are open now"
            )

    if clean == "brick_protocol/support/runner" or clean.startswith("brick_protocol/support/runner/"):
        return (
            f"superseded support runner path {clean}; SIMPLE-RUN-0 admits "
            "brick_protocol/support/operator/run.py as the only public Building run surface"
        )

    if clean == "brick_protocol/support/invocation" or clean.startswith("brick_protocol/support/invocation/"):
        return (
            f"superseded support invocation path {clean}; SIMPLE-RUN-0 admits "
            "brick_protocol/support/connection/agent_adapter.py as the only public Agent brain connection surface"
        )

    if clean == "brick_protocol/support/building_run" or clean.startswith("brick_protocol/support/building_run/"):
        return (
...
def allowed_path(path: str) -> bool:
    clean = path.rstrip("/")
    family_clean = c2_axis_relative(clean)
    is_dir = path.endswith("/")

    if is_dir:
        return (
            clean in ALLOWED_DIRS
            or family_clean in ALLOWED_DIRS
            ...
            or is_c2_link_route_policy_path(clean, is_dir=True)
    ...
    if is_c2_link_route_policy_path(clean, is_dir=False):
        return True
    ...
    # / kernel_checks) live directly under brick_protocol/support/checkers/lib as a flat package
    ...
    profile_parts = family_clean.split("/")
    if (
        len(profile_parts) == 4
    ...
    if is_project_building_lifecycle_path(clean, is_dir=False):
        return True
    if clean.startswith("brick_protocol/support/docs/spec/") and clean.endswith(".md"):
        return True
    if clean.startswith("brick_protocol/support/docs/reviews/") and clean.endswith(".md"):
        return True
    if clean.startswith("brick_protocol/support/docs/references/") and clean.endswith(".md"):
        return True
    if clean.startswith("brick_protocol/support/docs/projection/") and clean.endswith(".md"):
        return True
    if clean.startswith("brick_protocol/support/onboarding/assets/") and clean.endswith(
        (".ansi", ".ascii", ".md")
    ):
        return True
    return False
...
def main() -> int:
    ...
    print(
        ...
        "file pair, SIMPLE-RUN-0 brick_protocol/support/operator/run.py and brick_protocol/support/connection/agent_adapter.py "
        "surfaces, the AGENT-RESOURCE-TOOLKIT-0 brick_protocol/support/connection/agent_resources.py "
        "surface, the COO-SYNC-0 brick_protocol/support/connection/coo_sync.py projection writer "
        "surface, the MCP-PROJECTION-0 brick_protocol/support/connection/mcp_projection.py call-door "
        "surface, the BUILDING-OPERATION-SURFACE-0 brick_protocol/support/operator helper "
        ...
        "brick_protocol/support/recording exact-file family without __main__.py, the "
