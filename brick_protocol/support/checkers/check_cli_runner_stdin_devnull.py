...
timeout). The two CLI-runner spawns in brick_protocol/support/connection/adapter_subprocess.py
...
brick_protocol/support/connection/adapter_subprocess.py, finds the two named CLI-runner functions, and
...
_ADAPTER_REL = Path("brick_protocol/support/connection/adapter_subprocess.py")
