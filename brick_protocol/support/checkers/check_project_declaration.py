...
def _slug_seam_parity_failures(repo: Path) -> list[str]:
    ...
    from brick_protocol.support.checkers.check_package_path_admission import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    if violations:
        ...
        print(
            "prescription: declare the vessel via brick_protocol/agent/skills/project-creation/"
