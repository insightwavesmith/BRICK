...
# record. Derived from the existing record literals (see brick_protocol/support/operator/
...
# writer in ``brick_protocol/support/operator/evidence_assembly.py`` previously HAND-WROTE the
...
# derived emitter (``brick_protocol/support/recording/operator_evidence.py``) builds each record
