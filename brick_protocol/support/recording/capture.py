...
# the declaration loader (brick_protocol/support/operator/project_declaration.py) imports
...
# brick_protocol/link/movement.py MOVEMENT_LITERALS). This raw-capture set is deliberately broader and
