...
CONTRACT-DERIVED -- ``brick_protocol/support/recording/operator_evidence.py`` builds each event
from the capture-event field-spec in ``brick_protocol/support/recording/contracts.py``; this
        ...
        output_text_entries.append(
            {
                ...
                "source": "brick_protocol/support/operator/run.py adapter output text side-channel",
        ...
        received_entries.append(
            {
                ...
                "source": "brick_protocol/support/operator/run.py Agent receipt observations for completed steps",
    ...
    return {
        ...
        "entries": [
            ...
            },
            {
                ...
                "source": "brick_protocol/support/operator/run.py run_building_plan closed AgentFact returns",
            ...
            *output_text_entries,
            {
                "path": "raw/link.jsonl",
                "source": "brick_protocol/support/operator/run.py run_building_plan declared Link rows",
...
def agent_run_lifecycle_mapping(
    ...
    *,
    ...
    return {
        ...
        # brick_protocol/support/recording/operator_evidence.py builds each event by iterating the
        # capture-event field-spec (header order + per-event payload order) in
        # brick_protocol/support/recording/contracts.py; the event_id / role_in_event /
