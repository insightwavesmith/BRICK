...
``brick_protocol/support/operator/evidence_assembly.py`` was a god-module that hand-assembled
the raw records + claim facts for every axis crossing. Its per-family emitters
were lifted into ``brick_protocol/support/recording/claims_*.py`` collaborators behind a thin
