...
_PROOF_LIMITS = (
    ...
    "brick_protocol/agent/ remains the Agent resource source",
...
def _record(*, role: str, kind: str, target: str, path: Path, body: str) -> dict[str, Any]:
    return {
        ...
        "projection_status": "projection only; source remains brick_protocol/agent/",
        "body": body,
        "sha256": _sha256(body),
...
def render_agent_projection_sync_context(repo_root: str | Path | None = None) -> dict[str, Any]:
    ...
    observation, but it must not write local app files or modify brick_protocol/agent/.
    """
    ...
    return {
        ...
        "sync_out": {
            "direction": "brick_protocol/agent/ -> provider-native projection files",
            "planner_ref": "brick_protocol/support/connection/coo_sync.py::plan_agent_projection_sync",
            "writer_ref": "brick_protocol/support/connection/coo_sync.py::write_agent_projection_sync",
            "roles": roles,
            "targets": [
        ...
        "sync_in_observation": {
            ...
            "observer_ref": "brick_protocol/support/connection/coo_sync.py::observe_agent_projection_freshness",
            "automatic_agent_resource_write": False,
            "candidate_import_requires_building": True,
        },
        "forbidden_authority": [
            "provider projection as source truth",
            "automatic local-file to brick_protocol/agent/ overwrite",
