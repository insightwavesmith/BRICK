...
if __package__ in {None, ""}:
    ...
    # imports) AND brick_protocol/support/import_identity (the shim that provides the
...
_STATIC_RESOURCE_SPECS = (
    {
        ...
        "description": "Read-only COO Codex projection seed; source remains brick_protocol/agent/.",
    },
    {
        ...
        "description": "Read-only COO Claude projection seed; source remains brick_protocol/agent/.",
    },
    {
        ...
        "description": "Read-only admitted Agent Object team context from brick_protocol/agent/.",
    },
    {
    ...
    },
    {
        ...
        "description": "Read-only task source, shape registry, and Human+AI design contract from brick_protocol/brick/.",
    },
    {
        ...
        "description": "Read-only COO task intake chain context; source remains brick_protocol/brick/ and brick_protocol/agent/.",
    },
)
_PROOF_LIMITS = (
    "support MCP-shaped projection evidence only",
    "Agent resource meaning remains owned by brick_protocol/agent/",
    "Brick design meaning remains owned by brick_protocol/brick/",
    "brick_protocol/support/connection/agent_resources.py remains the admitted renderer",
    "brick_protocol/support/connection/building_design_toolkit.py is read-only support context",
    ...
    agent_packet_specs = tuple(
        {
            ...
            "description": f"Read-only rendered {_role_from_ref(ref)} Agent resource packet from brick_protocol/agent/.",
        }
...
def _source_for_kind(kind: str) -> str:
    if kind in {
        ...
        return "brick_protocol/agent/"
    if kind == "building-design-context":
        return "brick_protocol/brick/"
    if kind == "coo-operating-chain-context":
        return "brick_protocol/brick/ + brick_protocol/agent/ + brick_protocol/support/"
    raise MCPProjectionError(f"unsupported MCP projection resource kind: {kind}")
        ...
        "tools": [
            {
                ...
                "description": "Render an admitted Agent Object packet from brick_protocol/agent/ resources.",
                "inputSchema": {
                    "type": "object",
            ...
            },
            {
                ...
                "description": "Render admitted Agent Object team context from brick_protocol/agent/ resources.",
                "inputSchema": {
                    "type": "object",
                    "properties": {},
                    "additionalProperties": False,
            ...
            },
            {
                ...
                "description": "Render read-only BAR-v2 Building design context from brick_protocol/brick/.",
                "inputSchema": {
                    "type": "object",
                    "properties": {},
                    "additionalProperties": False,
...
def render_coo_operating_chain_context(repo_root: str | Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "source": "brick_protocol/brick/ + brick_protocol/agent/ + brick_protocol/support/",
        "coo_projection_skill": "brick-protocol-coo",
        "coo_agent_object_ref": "agent-object:coo",
        "task_intake_skill_ref": "skill:task_intake",
        "task_source_template_ref": "brick_protocol/brick/templates/tasks/source-template.md",
        "active_task_source_evidence_ref": "project/brick-protocol/buildings/<building-id>/work/task.md",
        "shape_catalog_ref": "brick_protocol/brick/templates/shapes/catalog.yaml",
        "shape_registry_ref": "brick_protocol/brick/templates/shapes/catalog.yaml",
        "design_contract_ref": "brick_protocol/brick/templates/building-design-contract.yaml",
        "operator_helper_ref": "brick_protocol/support/operator/building_operation.py::coo_operating_chain_packet",
        ...
        "startup_paths": [
            ...
            "brick_protocol/brick/templates/presets/fast-fix.md",
            "brick_protocol/brick/templates/presets/design-build-parallel.md",
            "brick_protocol/brick/templates/presets/high-risk-change-inspected.md",
            "brick_protocol/brick/templates/presets/governed-change-review.md",
            "brick_protocol/brick/templates/presets/app-feature-basic.md",
            "brick_protocol/brick/templates/presets/app-feature-inspected.md",
            "brick_protocol/brick/templates/presets/docs-simple-review.md",
            "brick_protocol/brick/templates/presets/portfolio-sequence.md",
            "brick_protocol/brick/templates/presets/brick-protocol-constitution-change.md",
            "brick_protocol/brick/templates/presets/brick-protocol-dashboard-dev-basic.md",
            "brick_protocol/brick/templates/presets/brick-protocol-dashboard-dev-inspected.md",
            "brick_protocol/brick/templates/presets/brick-protocol-engine-feature-hard.md",
            "brick_protocol/brick/templates/presets/brick-protocol-portfolio-driver.md",
            "brick_protocol/brick/templates/presets/brick-protocol-post-d-cleanup.md",
        ...
        "proof_limits": [
            ...
            "Brick task meaning remains owned by brick_protocol/brick/",
            "Agent resources remain owned by brick_protocol/agent/",
...
def _initialize_result() -> dict[str, Any]:
    return {
        ...
        "instructions": (
            ...
            "Agent meaning remains in brick_protocol/agent/. Link owns Movement."
        ),
    }
