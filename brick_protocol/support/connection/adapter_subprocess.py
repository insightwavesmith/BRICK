...
This is a PURE relocation out of ``brick_protocol/support/connection/agent_adapter.py``: the
...
# writer (brick_protocol/support/recording/adapter_usage_meter.py) maps the subset that overlaps
