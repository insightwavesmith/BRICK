// 화면용 한글 라벨. 정본 데이터는 brick_protocol/support/operator/label_map.json이고,
// reporter_notification_projection 커널 체크가 이 미러와의 parity를 검증한다.

// 브릭 종류 → 한글/아이콘. 키 = brick_protocol/brick/templates/bricks/<kind>
export const BRICK = {
...
// Link Movement → 한글 (정본: brick_protocol/support/operator/label_map.json — 패리티 핀 대상)
