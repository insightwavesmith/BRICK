...
def _closure_decision_normalized_key(key: Any) -> str:
    # Same rule as brick_protocol/agent/return_fact.py:123 _normalize_return_key.
...
def _report_label_value(
    ...
    *,
    ...
    if not key:
        return ""
    label_map = _read_json_mapping(repo / "brick_protocol" / "support" / "operator" / "label_map.json")
