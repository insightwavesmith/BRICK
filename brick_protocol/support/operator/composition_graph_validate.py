...
def _composition_validator_problems(
    ...
    problems: list[CompositionProblem] = []
    try:
        from brick_protocol.support.operator.plan_graph import _linear_plan_from_graph_plan  # noqa: PLC0415
        from brick_protocol.support.operator.plan_validation import validate_declared_building_plan  # noqa: PLC0415
