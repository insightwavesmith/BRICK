...
# (brick_protocol/support/operator/native_dispatch.py), which records a ONE-STEP caller-declared
    ...
    * vessel present but undeclared / charterless -> the verbatim rejection of
    ...
    if not vessel_dir.is_dir():
        raise ValueError(
            ...
            "brick_protocol.support.operator.project_creation.create_project); intake never "
            "invents a vessel"
        )
