...
def _adapter_result_with_write_observation(
    ...
    *,
    ...
    # (brick.comparison) and brick_protocol/support/recording (agent_step_observation).
    ...
    # RECORD (brick_protocol/support/recording): derive the named per-step facts from the RAW
    ...
    worktree_observation: dict[str, Any] = {
        ...
        # Brick-comparison + brick_protocol/support/recording facts land here as NESTED evidence for
