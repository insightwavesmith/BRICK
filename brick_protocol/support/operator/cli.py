...
if (_SOURCE_CANDIDATE_REPO_ROOT / "brick_protocol/support/operator/import_identity.py").is_file():
...
def build_parser() -> argparse.ArgumentParser:
    ...
    verify.add_argument("--all", action="store_true", help="Run every brick_protocol/support/checkers/profiles/*.yaml profile.")
