...
validate_transition_concern_evidence contract of brick_protocol/agent/return_fact.py). Judges no
...
# (Agent-returned AND machine-authored) is validated by brick_protocol/agent/return_fact
...
def _proof_obligation_transition_concern_observation(
    ...
    # The intake grammar (brick_protocol/agent/return_fact._validate_transition_concern_
