...
def _brick_kind_from_ref(value: Any) -> str | None:
    if not isinstance(value, str):
        return None
    match = re.search(r"brick_protocol/brick/templates/bricks/([^/]+)/brick\.md$", value)
    if match:
...
def _capability_map(repo: Path) -> dict[str, str]:
    result: dict[str, str] = {}
    for path in (repo / "brick_protocol/brick/templates/bricks").glob("*/brick.md"):
...
def _self_test(repo: Path) -> tuple[int, tuple[str, ...]]:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        base = {
            "kind": "work",
            "write_scope": {"allowed_paths": ["brick_protocol/support/operator/task_order_preflight.py"]},
        }
        dirty_missing_done = _write_fixture(
            ...
            {
                **base,
                "work_statement": "## Deliverables\nD1: edit brick_protocol/support/operator/task_order_preflight.py\n",
            },
        )
        dirty_read_proof = _write_fixture(
            ...
            {
                "kind": "development",
                "work_statement": "## Deliverables\nD1: inspect brick_protocol/support/operator/task_order_preflight.py\n## Done Criteria\nobserved",
                "proof_obligations": "uv run python brick_protocol/support/checkers/check_profile.py --all",
                "write_scope": {"allowed_paths": ["brick_protocol/support/operator/task_order_preflight.py"]},
            },
        )
        ...
        dirty_scope_mismatch = _write_fixture(
            ...
            "scope-mismatch.json",
            {
                **base,
                "work_statement": (
                    "## Deliverables\nD1: edit brick_protocol/support/operator/not_declared.py\n"
                    "## Done Criteria\nobserved"
                ),
            },
        )
        dirty_scope_prefix = _write_fixture(
            ...
            {
                **base,
                "write_scope": {"allowed_paths": ["brick_protocol/support/operator/**"]},
                "work_statement": (
                    "## Deliverables\nD1: edit brick_protocol/support/operator_extra.py\n"
                    "## Done Criteria\nobserved"
                ),
            },
        )
        clean_scope_star = _write_fixture(
            ...
            {
                **base,
                "write_scope": {"allowed_paths": ["brick_protocol/support/operator/*.py"]},
                "work_statement": (
                    "## Deliverables\nD1: edit brick_protocol/support/operator/new_thing.py\n"
                    "## Done Criteria\nobserved"
                ),
            },
        )
        clean_scope_question = _write_fixture(
            ...
            {
                **base,
                "write_scope": {"allowed_paths": ["brick_protocol/support/operator/a?c.py"]},
                "work_statement": (
                    "## Deliverables\nD1: edit brick_protocol/support/operator/abc.py\n"
                    "## Done Criteria\nobserved"
                ),
            },
        )
        clean_scope_char_class = _write_fixture(
            ...
            {
                **base,
                "write_scope": {"allowed_paths": ["brick_protocol/support/operator/[ab]bc.py"]},
                "work_statement": (
                    "## Deliverables\nD1: edit brick_protocol/support/operator/abc.py\n"
                    "## Done Criteria\nobserved"
                ),
