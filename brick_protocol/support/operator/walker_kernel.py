...
def _route_v2_view_observation(
    *,
    ...
    Eligibility uses the shared SHAPE B helper also used by render_route_v2_view.
    The observation remains advisory and is not adopted as Movement.
    """
    ...
    shared = classify_route_v2_concern_eligibility(concern_kind) if concern_kind else {}
    return {
    ...
    try:
        if is_replay:
            ...
            adapter_dispatch_timing = {
                ...
                "timing_source": "brick_protocol/support/operator/walker_kernel.py:process_one_node",
    ...
    while True:
        ...
        if (concern is None and not human_disposition_reroute_target) or (
            ...
            if target_classification.kind in ("ambiguous", "none"):
                ...
                # contract field-spec (brick_protocol/support/recording/walker_evidence.py iterates
                # brick_protocol/support/recording/contracts.py). No inline dict literal: the shape can
