...
# _FORBIDDEN_BRICK_KWARGS moved to the BRICK axis (brick_protocol/brick/spec.py) at E2/S1 — the
...
# (brick_protocol/agent/spec.py) at E2/S1 — casting authoring is Agent-axis property. The retained
...
# DERIVED_WORKTREE_WRITE_SCOPE default moved to the BRICK axis (brick_protocol/brick/spec.py) at
...
# AgentSpec moved to the AGENT axis (brick_protocol/agent/spec.py) and BrickSpec to the BRICK axis
# (brick_protocol/brick/spec.py) at E2/S1-S2 — the per-lane/per-node authoring carriers belong to
...
# The ``brick()`` authoring verb moved to the BRICK axis (brick_protocol/brick/spec.py) and the
# ``agent()`` verb to the AGENT axis (brick_protocol/agent/spec.py) at E2/S1-S2. Both are imported
...
# _optional_bare_or_ref moved to the AGENT axis (brick_protocol/agent/spec.py) at E2/S1 with the
