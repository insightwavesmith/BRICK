...
# DERIVED from the Link gate single-source data table (brick_protocol/link/spec.GATE_REGISTRY,
...
# brick_protocol/link/gate.py (the link_gate crossing); the derivation is an intra-axis read.
