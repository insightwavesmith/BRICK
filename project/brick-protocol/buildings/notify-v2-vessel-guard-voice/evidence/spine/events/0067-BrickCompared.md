...
- alias_fact_refs: ["brick-comparison:notify-v2-vessel-guard-voice:notify-v2-vessel-guard-voice-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 67
- source_fact_ref: "brick-comparison:06:notify-v2-vessel-guard-voice-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: # Notification v2 — real-vessel-only bell (F12) + human voice + stage dial"
