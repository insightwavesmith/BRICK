...
- alias_fact_refs: ["brick-comparison:notify-v2-vessel-guard-voice:notify-v2-vessel-guard-voice-work"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 28
- source_fact_ref: "brick-comparison:02:notify-v2-vessel-guard-voice-work"
- spine_schema_version: "spine-v1"
- work_reference: "work Brick for task-source:inline-statement: # Notification v2 — real-vessel-only bell (F12) + human voice + stage dial"
