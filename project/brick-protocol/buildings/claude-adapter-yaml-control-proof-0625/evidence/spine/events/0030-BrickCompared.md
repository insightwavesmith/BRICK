...
- alias_fact_refs: ["brick-comparison:claude-adapter-yaml-control-proof-0625:claude-adapter-yaml-control-proof-0625-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 30
- source_fact_ref: "brick-comparison:03:claude-adapter-yaml-control-proof-0625-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: BRICK COO declared P3 read-only proof Building: Claude adapter / YAML control proof."
