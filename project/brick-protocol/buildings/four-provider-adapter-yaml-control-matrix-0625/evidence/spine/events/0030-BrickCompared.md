...
- alias_fact_refs: ["brick-comparison:four-provider-adapter-yaml-control-matrix-0625:four-provider-adapter-yaml-control-matrix-0625-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 30
- source_fact_ref: "brick-comparison:03:four-provider-adapter-yaml-control-matrix-0625-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: P4 adapter/YAML control matrix for the current BRICK four-provider dogfood lane."
