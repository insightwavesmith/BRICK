...
- alias_fact_refs: ["brick-comparison:iap-dashboard-sink-passport-0612:iap-dashboard-sink-passport-0612-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 67
- source_fact_ref: "brick-comparison:06:iap-dashboard-sink-passport-0612-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: report-sink:dashboard attaches the IAP passport (Authorization: Bearer <SA-signed JWT>) when (and ONLY when) a key-path environment variable is present, so an IAP-enabled dashboard accepts machine pushes end-to-end. Stateless per-send signi"
