...
- alias_fact_refs: ["brick-comparison:f9b-midwalk-not-closed:f9b-midwalk-not-closed-code-attack-qa"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 21
- source_fact_ref: "brick-comparison:02:f9b-midwalk-not-closed-code-attack-qa"
- spine_schema_version: "spine-v1"
- work_reference: "code_attack_qa Brick for task-source:inline-statement: # F9B: mid-walk buildings still project 'closed' (the remaining half of F9)"
