...
- alias_fact_refs: ["brick-comparison:f9b-midwalk-not-closed:f9b-midwalk-not-closed-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 31
- source_fact_ref: "brick-comparison:03:f9b-midwalk-not-closed-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: # F9B: mid-walk buildings still project 'closed' (the remaining half of F9)"
