...
- alias_fact_refs: ["brick-comparison:p6c-concurrent-dispatch-0617:p6c-concurrent-dispatch-0617-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 37
- source_fact_ref: "brick-comparison:04:p6c-concurrent-dispatch-0617-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: # P6-C: 독립 fan-out 가지 동시 디스패치 (전진 병렬, pool=1 기본=byte-identical, pool=N 옵트인=증명)"
