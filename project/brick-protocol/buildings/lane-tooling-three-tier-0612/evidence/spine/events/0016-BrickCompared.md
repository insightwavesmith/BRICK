...
- alias_fact_refs: ["brick-comparison:lane-tooling-three-tier-0612:lane-tooling-three-tier-0612-design"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 16
- source_fact_ref: "brick-comparison:01:lane-tooling-three-tier-0612-design"
- spine_schema_version: "spine-v1"
- work_reference: "design Brick for task-source:inline-statement: Replace the binary tool rule in the adapter instruction rendering with a three-tier model so reviewer/leader/design lanes can actually READ the artifact they are reviewing, and require review returns to be grounded in inspected artifacts. T"
