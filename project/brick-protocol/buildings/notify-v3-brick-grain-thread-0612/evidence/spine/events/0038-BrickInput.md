...
- work_statement: "axis_attack_qa Brick for task-source:inline-statement: # notify-v3 — brick-grain Slack notifications: one thread per building, one reply per incident"
