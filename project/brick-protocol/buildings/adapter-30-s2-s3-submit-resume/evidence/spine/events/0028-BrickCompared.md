...
- alias_fact_refs: ["brick-comparison:adapter-30-s2-s3-submit-resume:adapter-30-s2-s3-submit-resume-work"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 28
- source_fact_ref: "brick-comparison:02:adapter-30-s2-s3-submit-resume-work"
- spine_schema_version: "spine-v1"
- work_reference: "work Brick for task-source:inline-statement: Complete the chat-session adapter's engine surface. S1 (park) is DONE and committed: a chat-session step records a closed work envelope (work/step-outputs/<step>/work-envelope.json) + a distinct park record (parked.json) + raw/chat-session-"
