...
- axis_scope: ["Link"]
- checked_public_fact: "brick-comparison:adapter-30-s2-s3-submit-resume:adapter-30-s2-s3-submit-resume-work"
...
- run_segment: 2
- sequence_index: 24
- source_fact_ref: "sufficiency-fact-movement:02:adapter-30-s2-s3-submit-resume-work"
