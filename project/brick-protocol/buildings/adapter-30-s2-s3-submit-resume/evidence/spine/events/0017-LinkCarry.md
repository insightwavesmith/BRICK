...
- budget_source_refs: ["work/declared-building-plan.json#node_reroute_budgets.brick-adapter-30-s2-s3-submit-resume-design","work/link-launch-policy.json#node_reroute_budgets.brick-adapter-30-s2-s3-submit-resume-design"]
- carry_budget_evidence_ref: "evidence/claim_trace/link/carry_trace.json#carry-budget:adapter-30-s2-s3-submit-resume:node:brick-adapter-30-s2-s3-submit-resume-design"
- declared_budget: 1
...
- run_segment: 1
- sequence_index: 17
- source_fact_ref: "carry-budget:adapter-30-s2-s3-submit-resume:node:brick-adapter-30-s2-s3-submit-resume-design"
- spine_schema_version: "spine-v1"
- support_created_bal_fact: false
- target_boundary_ref: "brick-adapter-30-s2-s3-submit-resume-design"
