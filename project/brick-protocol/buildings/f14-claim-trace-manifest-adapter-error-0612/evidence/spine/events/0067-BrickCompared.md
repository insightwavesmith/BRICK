...
- alias_fact_refs: ["brick-comparison:f14-claim-trace-manifest-adapter-error-0612:f14-claim-trace-manifest-adapter-error-0612-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 67
- source_fact_ref: "brick-comparison:06:f14-claim-trace-manifest-adapter-error-0612-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: # F14 — adapter-error 경유 폐장 빌딩의 claim_trace/manifest 불일치 (게이트 RED)"
