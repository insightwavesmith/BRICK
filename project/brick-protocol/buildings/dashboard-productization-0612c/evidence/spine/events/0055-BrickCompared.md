...
- alias_fact_refs: ["brick-comparison:dashboard-productization-0612c:dashboard-productization-0612c-evidence-integrity"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 55
- source_fact_ref: "brick-comparison:05:dashboard-productization-0612c-evidence-integrity"
- spine_schema_version: "spine-v1"
- work_reference: "evidence_integrity Brick for task-source:inline-statement: Make support/dashboard/ shippable to ANOTHER COMPANY behind THEIR OWN access wall: documented deploy recipes, env hygiene, an operator bake verb, and label polish. App stays credential-free (protocol law) — the only app-level secret is env-"
