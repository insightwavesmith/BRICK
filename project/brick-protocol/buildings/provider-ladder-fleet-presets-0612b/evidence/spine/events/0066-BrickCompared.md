...
- alias_fact_refs: ["brick-comparison:provider-ladder-fleet-presets-0612b:provider-ladder-fleet-presets-0612b-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 66
- source_fact_ref: "brick-comparison:06:provider-ladder-fleet-presets-0612b-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: Open the BUILDER-side path for per-step provider/model selection (the ENGINE already honors step-level selected_adapter_ref/selected_model_ref — plan_validation.py:156-163 falls back step->plan; verified) and add fleet presets so recon/revi"
