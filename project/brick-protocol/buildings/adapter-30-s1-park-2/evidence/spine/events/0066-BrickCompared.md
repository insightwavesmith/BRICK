...
- alias_fact_refs: ["brick-comparison:adapter-30-s1-park-2:adapter-30-s1-park-2-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 66
- source_fact_ref: "brick-comparison:06:adapter-30-s1-park-2-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: Implement seam S1 of the chat-session adapter, per the Smith-approved design (v2, 2026-06-11): when a plan step's declared adapter is `adapter:chat-session`, the engine must PARK — record a work envelope + a park record (support-only record"
