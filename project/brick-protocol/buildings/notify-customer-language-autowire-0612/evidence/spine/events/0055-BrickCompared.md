...
- alias_fact_refs: ["brick-comparison:notify-customer-language-autowire-0612:notify-customer-language-autowire-0612-evidence-integrity"]
- axis_scope: ["Brick"]
...
- run_segment: 2
- sequence_index: 55
- source_fact_ref: "brick-comparison:05:notify-customer-language-autowire-0612-evidence-integrity"
- spine_schema_version: "spine-v1"
- work_reference: "evidence_integrity Brick for task-source:inline-statement: Make BRICK's notifications speak the customer's language and flow automatically. Two halves, one surface (support/operator/reporter.py + report_sinks.py): (A) the Slack message must read like a status update a non-engineer understands — wor"
