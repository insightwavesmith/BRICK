...
- alias_fact_refs: ["brick-comparison:f11-session-text-dict-key-scan-0612:f11-session-text-dict-key-scan-0612-closure"]
- axis_scope: ["Brick"]
...
- run_segment: 1
- sequence_index: 32
- source_fact_ref: "brick-comparison:03:f11-session-text-dict-key-scan-0612-closure"
- spine_schema_version: "spine-v1"
- work_reference: "closure Brick for task-source:inline-statement: # F11: chat-session leak rejector misses UUID/ULID-shaped text in dict KEY position"
