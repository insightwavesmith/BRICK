...
- **묶음9 신설** (= 패키지 F, P7 — free-green 계층화) 【**Smith 게이트 필수**】:
...
## 2. Smith 결정 대기 (발주 차단 아님 — Phase 1~3은 결정 불요로 즉시 진행 가능)

1. **헌법 비준** — constitution-amendment-draft-0705.md.
2. **묶음9 verify 계층화 승인** — 헌법 성공판정 ③ 문구·고객 표면 의미 변경과 얽힘.
