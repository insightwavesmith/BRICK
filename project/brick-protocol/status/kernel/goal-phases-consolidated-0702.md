...
| **P3 소형 병렬 잔여** | Case 8 정찰(읽기전용) · 인체공학 마찰청산 묶음(표 13·14·16) | 슬롯 나는 대로 |
| **P4 대형(묶음)** | #15 가중치→그래프 초안기 + #12 build() 단일 진입 (cli/assembly 이음새 공유) | 순서 재론 중(0706 야간 회고 — §P-결정) |
| **P5 저우선** | T10 fresh 0705c(완주 스탬프) | 의존 없음 |
| **P-결정(Smith)** | 0706 야간 회고 4제안 — ①마찰청산 웨이브 선행 ②#12 앞당김 ③규칙 만료태그 ④판단면 3점 고정 — COO 판단 보고됨, 채택은 Smith | 대기 |
