...
| T10 동적 그래프 | 방향 확정("판을 새로 안 깐다" — 홀드 후 같은 판에 신규 노드), 비용 engine-adjacent 하향, 3슬라이스 경로 조사 완료. **Smith 결정 3논점(권한 배분/승인 주체/birth-cert 개정 방식) 전 발주 금지 🚧** | Smith 대기 |
...
**이 골에서 안 하는 것**: T10(Smith 3논점), 엔진 수리 전부(S-a2·S-d 수리·K-of-N
디스패치), P8 신뢰성 반복(분해 창과 배타), #23 레거시 정리, 소급 원장 등재.
