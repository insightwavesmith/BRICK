...
- `/Users/smith/projects/deku/docs/Deku_ARCHITECTURE_Review.md` — **sole design authority**
- `/Users/smith/projects/deku/docs/COO_ACTIVE_GOAL_FUGU_ROUTER.md` (active sprint if any)
